...
func init() {
	...
	mainChar.Animations[string(model.IDLE_FACE_RIGHT)] = utils.ReadMultipleData(folderData, []string{"data/SLR.png"})
	mainChar.Animations[string(model.IDLE_FACE_LEFT)] = utils.ReadMultipleData(folderData, []string{"data/SRL.png"})
	mainChar.Animations[string(model.IDLE_FACE_UP)] = utils.ReadMultipleData(folderData, []string{"data/SBU.png"})
	mainChar.Animations[string(model.IDLE_FACE_DOWN)] = utils.ReadMultipleData(folderData, []string{"data/STD.png"})
	mainChar.Animations[string(model.WALK_LEFT_TO_RIGHT)] = utils.ReadMultipleData(folderData, []string{"data/WLR1.png", "data/WLR2.png", "data/WLR3.png", "data/WLR4.png", "data/WLR5.png", "data/WLR6.png"})
	mainChar.Animations[string(model.WALK_RIGHT_TO_LEFT)] = utils.ReadMultipleData(folderData, []string{"data/WRL1.png", "data/WRL2.png", "data/WRL3.png", "data/WRL4.png", "data/WRL5.png", "data/WRL6.png"})
	mainChar.Animations[string(model.WALK_DOWN_TO_UP)] = utils.ReadMultipleData(folderData, []string{"data/WBU1.png", "data/WBU2.png", "data/WBU3.png", "data/WBU4.png", "data/WBU5.png", "data/WBU6.png"})
	mainChar.Animations[string(model.WALK_UP_TO_DOWN)] = utils.ReadMultipleData(folderData, []string{"data/WTD1.png", "data/WTD2.png", "data/WTD3.png", "data/WTD4.png", "data/WTD5.png", "data/WTD6.png"})
	game.AddCharacter(mainChar)

	location1 := model.NewLocation("Stanza di test 1")
	location2 := model.NewLocation("Stanza di test 2")

	itemNote := model.NewItem("Note", false, true, utils.ReadData(folderData, "data/Note.png"))
	game.AddItem(itemNote)

	itemKey := model.NewItem("Key", true, true, utils.ReadData(folderData, "data/Key.png"))
	game.AddItem(itemKey)

	itemDoorToLocation2 := model.NewItem("Door to 2", false, false, utils.ReadData(folderData, "data/Note.png"))
	game.AddItem(itemDoorToLocation2)

	itemDoorToLocation1 := model.NewItem("Door to 1", false, false, utils.ReadData(folderData, "data/Note.png"))
